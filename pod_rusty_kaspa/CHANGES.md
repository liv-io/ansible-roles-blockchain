...
- Update pod_rusty_kaspa_rusty_kaspa_version from 2.0.0-1 to 2.0.1-1

## 2.0.0-1 (2026-06-08)

### Changes

- Update pod_rusty_kaspa_rusty_kaspa_version from 1.1.0-1 to 2.0.0-1

## 1.1.0-1 (2026-03-04)

### Features

- Update pod_rusty_kaspa_rusty_kaspa_version from 1.0.1-3 to 1.1.0-1
